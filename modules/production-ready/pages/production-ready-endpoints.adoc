...
[TIP]
====
Rather than hardcoding those values, you could also xref:howto:howto-properties-and-configuration.adoc#howto-automatic-expansion[expand info properties at build time].
...
See "xref:howto:howto-build.adoc#howto-git-info[Generate git information]" for more details.
...
See "xref:howto:howto-build.adoc#howto-build-info[Generate build information]" for more details.
