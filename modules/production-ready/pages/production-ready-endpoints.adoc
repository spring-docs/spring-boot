...
[TIP]
====
Rather than hardcoding those values, you could also xref:spring-boot-reference-documentation:howto.adoc#howto-automatic-expansion[expand info properties at build time].
...
See "xref:spring-boot-reference-documentation:howto.adoc#howto-git-info[Generate git information]" for more details.
...
See "xref:spring-boot-reference-documentation:howto.adoc#howto-build-info[Generate build information]" for more details.
