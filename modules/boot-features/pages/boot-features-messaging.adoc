...
The properties supported by auto configuration are shown in xref:appendix:common-application-properties.adoc#common-application-properties[common-application-properties].
