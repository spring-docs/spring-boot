...
* xref:howto:howto-embedded-web-servers.adoc#howto-configure-ssl[SSL]
* xref:howto:howto-embedded-web-servers.adoc#how-to-enable-http-response-compression[HTTP compression]
...
For instance, xref:howto:howto-embedded-web-servers.adoc#howto-configure-accesslogs[access logs] can be configured with specific features of the embedded servlet container.
