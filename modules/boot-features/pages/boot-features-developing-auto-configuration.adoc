...
Make sure to xref:appendix:configuration-metadata.adoc#configuration-metadata-annotation-processor[trigger meta-data generation] so that IDE assistance is available for your keys as well.
