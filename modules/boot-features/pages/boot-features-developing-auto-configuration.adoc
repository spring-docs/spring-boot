...
Make sure to xref:appendix:configuration-metadata:configuration-metadata-annotation-processor.adoc#configuration-metadata-annotation-processor[trigger meta-data generation] so that IDE assistance is available for your keys as well.
