...
Make sure to xref:spring-boot-reference-documentation:appendix.adoc#configuration-metadata-annotation-processor[trigger meta-data generation] so that IDE assistance is available for your keys as well.
