...
. xref:spring-boot-reference-documentation:using-boot.adoc#using-boot-devtools-globalsettings[Devtools global settings properties] in the `$HOME/.config/spring-boot` folder when devtools is active.
...
See the _xref:spring-boot-reference-documentation:howto.adoc#howto-use-short-command-line-arguments[howto-use-short-command-line-arguments]_ how-to for details.
...
See xref:spring-boot-reference-documentation:howto.adoc#howto-customize-the-environment-or-application-context[howto-customize-the-environment-or-application-context] for details.
...
See the xref:spring-boot-reference-documentation:appendix.adoc#configuration-metadata[appendix] for details.
...
See the "xref:spring-boot-reference-documentation:production-ready.adoc#production-ready-endpoints[ Production ready features]" section for details.
...
| xref:spring-boot-reference-documentation:appendix.adoc#configuration-metadata[Meta-data support]
| Yes
| No
