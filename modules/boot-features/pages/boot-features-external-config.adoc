...
. xref:using-boot:using-boot-devtools.adoc#using-boot-devtools-globalsettings[Devtools global settings properties] in the `$HOME/.config/spring-boot` folder when devtools is active.
...
See the _xref:howto:howto-properties-and-configuration.adoc#howto-use-short-command-line-arguments[howto-use-short-command-line-arguments]_ how-to for details.
...
See xref:howto:howto-spring-boot-application.adoc#howto-customize-the-environment-or-application-context[howto-customize-the-environment-or-application-context] for details.
