...
See xref:howto:howto-properties-and-configuration.adoc#howto-change-configuration-depending-on-the-environment[howto-change-configuration-depending-on-the-environment] for more details.
