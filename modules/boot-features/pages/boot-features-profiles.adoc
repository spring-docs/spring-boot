...
See xref:howto:howto-properties-and-configuration:howto-change-configuration-depending-on-the-environment.adoc#howto-change-configuration-depending-on-the-environment[howto-change-configuration-depending-on-the-environment] for more details.
