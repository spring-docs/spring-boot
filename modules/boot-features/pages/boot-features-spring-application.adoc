...
NOTE: Spring Boot provides numerous `FailureAnalyzer` implementations, and you can xref:howto:howto-spring-boot-application.adoc#howto-failure-analyzer[add your own].
