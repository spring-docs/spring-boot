...
NOTE: Spring Boot provides numerous `FailureAnalyzer` implementations, and you can xref:spring-boot-reference-documentation:howto.adoc#howto-failure-analyzer[add your own].
