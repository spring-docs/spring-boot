...
The `@LocalServerPort` annotation can be used to xref:howto:howto-embedded-web-servers:howto-discover-the-http-port-at-runtime.adoc#howto-discover-the-http-port-at-runtime[inject the actual port used] into your test.
