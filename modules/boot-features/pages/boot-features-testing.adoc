...
As long as you xref:spring-boot-reference-documentation:using-boot.adoc#using-boot-structuring-your-code[ structured your code] in a sensible way, your main configuration is usually found.
...
The `@LocalServerPort` annotation can be used to xref:spring-boot-reference-documentation:howto.adoc#howto-discover-the-http-port-at-runtime[inject the actual port used] into your test.
...
TIP: A list of the auto-configurations that are enabled by `@JsonTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@WebMvcTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
More details on how to use Spring Security's `MockMvc` support can be found in this _xref:spring-boot-reference-documentation:howto.adoc#howto-use-test-with-spring-security[howto-use-test-with-spring-security]_ how-to section.
...
TIP: A list of the auto-configurations that are enabled by `@WebFluxTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@DataJpaTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configurations that are enabled by `@JdbcTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configurations that are enabled by `@DataJdbcTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configurations that are enabled by `@JooqTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@DataMongoTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@DataNeo4jTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@DataRedisTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@DataLdapTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@RestClientTest` can be xref:spring-boot-reference-documentation:appendix.adoc#test-auto-configuration[found in the appendix].
