...
Several configuration properties are provided for xref:spring-boot-reference-documentation:howto.adoc#howto-customize-the-jackson-objectmapper[customizing the configuration of the `ObjectMapper`].
