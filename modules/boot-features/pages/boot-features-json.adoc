...
Several configuration properties are provided for xref:howto:howto-spring-mvc:howto-customize-the-jackson-objectmapper.adoc#howto-customize-the-jackson-objectmapper[customizing the configuration of the `ObjectMapper`].
