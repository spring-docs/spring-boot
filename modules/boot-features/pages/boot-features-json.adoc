...
Several configuration properties are provided for xref:howto:howto-spring-mvc.adoc#howto-customize-the-jackson-objectmapper[customizing the configuration of the `ObjectMapper`].
