...
TIP: Spring Boot provides various conversion mechanism with advanced value formatting, make sure to review xref:boot-features:boot-features-external-config.adoc#boot-features-external-config-conversion[ the properties conversion section].
