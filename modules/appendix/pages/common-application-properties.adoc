...
TIP: Spring Boot provides various conversion mechanism with advanced value formatting, make sure to review xref:boot-features:boot-features-external-config:boot-features-external-config-typesafe-configuration-properties.adoc#boot-features-external-config-conversion[ the properties conversion section].
