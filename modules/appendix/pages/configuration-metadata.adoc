...
| `logger-name`
| Auto-completes valid logger names and xref:boot-features:boot-features-logging:boot-features-custom-log-groups.adoc#boot-features-custom-log-groups[logger groups].
...
==== Logger Name
The **logger-name** provider auto-completes valid logger names and xref:boot-features:boot-features-logging:boot-features-custom-log-groups.adoc#boot-features-custom-log-groups[logger groups].
