...
| `logger-name`
| Auto-completes valid logger names and xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-custom-log-groups[logger groups].
...
==== Logger Name
The **logger-name** provider auto-completes valid logger names and xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-custom-log-groups[logger groups].
