...
It also provides a xref:using-boot:using-boot-build-systems.adoc#using-boot-dependency-management[`dependency-management`] section so that you can omit `version` tags for "`blessed`" dependencies.
