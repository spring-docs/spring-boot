...
Typically, your Maven POM file inherits from the `spring-boot-starter-parent` project and declares dependencies to one or more xref:using-boot:using-boot-build-systems.adoc#using-boot-starter["`Starters`"].
...
In those cases, see xref:using-boot:using-boot-build-systems.adoc#using-boot-maven-without-a-parent[using-boot-maven-without-a-parent] for an alternative solution that uses an `import` scope.
...
Typically, your project declares dependencies to one or more xref:using-boot:using-boot-build-systems.adoc#using-boot-starter[ "`Starters`"].
