...
The next section covers Spring Boot's "xref:build-tool-plugins:build-tool-plugins.adoc#build-tool-plugins[ Build tool plugins]", which you can use with Gradle or Maven.
