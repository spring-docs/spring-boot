...
The next section covers Spring Boot's "xref:spring-boot-reference-documentation:build-tool-plugins.adoc#build-tool-plugins[ Build tool plugins]", which you can use with Gradle or Maven.
