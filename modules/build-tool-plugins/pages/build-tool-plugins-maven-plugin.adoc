...
TIP: See the "`xref:howto:howto-traditional-deployment:howto-create-a-deployable-war-file.adoc#howto-create-a-deployable-war-file[howto-create-a-deployable-war-file]`" section for more details on how to create a deployable war file.
