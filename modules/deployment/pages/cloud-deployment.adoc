...
In this section, we look at what it takes to get the xref:spring-boot-reference-documentation:getting-started.adoc#getting-started-first-application[ simple application that we developed] in the "`Getting Started`" section up and running in the Cloud.
