...
The next section goes on to cover the _xref:spring-boot-reference-documentation:cli.adoc#cli[ Spring Boot CLI]_, or you can jump ahead to read about _xref:spring-boot-reference-documentation:build-tool-plugins.adoc#build-tool-plugins[ build tool plugins]_.
