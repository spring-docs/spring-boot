...
NOTE: Profiles activated in the above files will not affect the loading of xref:boot-features:boot-features-external-config:boot-features-external-config-profile-specific-properties.adoc#boot-features-external-config-profile-specific-properties[ profile-specific configuration files].
