...
NOTE: Profiles activated in the above files will not affect the loading of xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-external-config-profile-specific-properties[ profile-specific configuration files].
