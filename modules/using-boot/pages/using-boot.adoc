...
If you are starting out with Spring Boot, you should probably read the _xref:spring-boot-reference-documentation:getting-started.adoc#getting-started[ Getting Started]_ guide before diving into this section.
