...
The executable archive cannot be used as a dependency as the xref:spring-boot-reference-documentation:appendix.adoc#executable-jar-jar-file-structure[executable jar format] packages application classes in `BOOT-INF/classes`.
