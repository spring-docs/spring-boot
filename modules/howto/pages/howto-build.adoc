...
The executable archive cannot be used as a dependency as the xref:appendix:executable-jar:executable-jar-nested-jars.adoc#executable-jar-jar-file-structure[executable jar format] packages application classes in `BOOT-INF/classes`.
