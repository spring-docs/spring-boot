...
For more details, see "`xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-customizing-embedded-containers[boot-features-customizing-embedded-containers]`" in the '`Spring Boot Features`' section, or the {spring-boot-autoconfigure-module-code}/web/ServerProperties.java[`ServerProperties`] source code.
...
See the list of xref:spring-boot-reference-documentation:appendix.adoc#common-application-properties[common-application-properties].
