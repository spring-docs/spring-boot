...
This is done for you automatically if you enable the xref:boot-features:boot-features-logging:boot-features-logging-console-output.adoc#boot-features-logging-console-output[debug mode].
