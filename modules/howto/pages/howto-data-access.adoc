...
If you need to externalize some settings, you can bind your `DataSource` to the environment (see "`xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-external-config-3rd-party-configuration[boot-features-external-config-3rd-party-configuration]`").
