...
See "`xref:boot-features:boot-features-external-config.adoc#boot-features-external-config-yaml[boot-features-external-config-yaml]`" in the '`Spring Boot features`' section for more information about YAML.
