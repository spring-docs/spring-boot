...
By default, properties from different sources are added to the Spring `Environment` in a defined order (see "`xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-external-config[boot-features-external-config]`" in the '`Spring Boot features`' section for the exact order).
...
See "`xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-external-config-yaml[boot-features-external-config-yaml]`" in the '`Spring Boot features`' section for more information about YAML.
...
See "`xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-profiles[boot-features-profiles]`" in the "`Spring Boot features`" section for more information.
...
The appendix includes an xref:spring-boot-reference-documentation:appendix.adoc#common-application-properties[ `application.properties`] example with a list of the most common properties supported by Spring Boot.
