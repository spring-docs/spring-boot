...
As described in xref:boot-features:boot-features-resttemplate:boot-features-resttemplate-customization.adoc#boot-features-resttemplate-customization[boot-features-resttemplate-customization], you can use a `RestTemplateCustomizer` with `RestTemplateBuilder` to build a customized `RestTemplate`.
