...
As described in xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-resttemplate-customization[boot-features-resttemplate-customization], you can use a `RestTemplateCustomizer` with `RestTemplateBuilder` to build a customized `RestTemplate`.
