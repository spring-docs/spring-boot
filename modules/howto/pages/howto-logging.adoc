...
You can also use `logback-spring.xml` if you want to use the xref:spring-boot-reference-documentation:boot-features.adoc#boot-features-logback-extensions[Spring Boot Logback extensions].
