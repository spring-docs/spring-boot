...
You can also use `logback-spring.xml` if you want to use the xref:boot-features:boot-features-logging.adoc#boot-features-logback-extensions[Spring Boot Logback extensions].
