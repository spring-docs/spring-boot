...
See "`xref:boot-features:boot-features-spring-application.adoc#boot-features-application-events-and-listeners[Application Events and Listeners]`" in the '`Spring Boot features`' section for a complete list.
...
See "`xref:boot-features:boot-features-spring-application.adoc#boot-features-fluent-builder-api[boot-features-fluent-builder-api]`" in the '`Spring Boot features`' section for more information.
