...
If you use the `spring-boot-actuator` (see xref:production-ready:production-ready.adoc#production-ready[the Actuator chapter]), there is also a `conditions` endpoint that renders the report in JSON.
...
See "`xref:boot-features:boot-features-spring-application:boot-features-application-events-and-listeners.adoc#boot-features-application-events-and-listeners[Application Events and Listeners]`" in the '`Spring Boot features`' section for a complete list.
...
See "`xref:boot-features:boot-features-spring-application:boot-features-fluent-builder-api.adoc#boot-features-fluent-builder-api[boot-features-fluent-builder-api]`" in the '`Spring Boot features`' section for more information.
